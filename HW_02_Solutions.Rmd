...
```{r, echo=F}
knitr::kable(summarize(gm_byContinent,min(gdpPercap),median(gdpPercap),mean(gdpPercap),sd(gdpPercap),max(gdpPercap)))
```
...
```{r, echo=F}
 knitr::kable(summarize(gm_byContinent,min(lifeExp),median(lifeExp),mean(lifeExp),sd(lifeExp),max(lifeExp)))
```
